...
import org.glucosio.android.tools.ReadingToPdf;
...
public class ExportPdfPresenter {
    ...
    public ExportPdfPresenter(Activity activity, DatabaseHandler databaseHandler) {
        mActivity = activity;
            ...
            new AsyncTask<Void, Void, String>() {
                ...
                protected String doInBackground(Void... params) {
                    ...
                    if (dirExists()) {
                        ...
                        return ReadingToPdf.createPDFFile(mActivity, realm, readings, preferredUnit);
                    } else {
